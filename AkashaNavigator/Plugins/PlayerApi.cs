...
#region Internal Methods
    ...
    private CoreWebView2? GetWebView()
    {
        ...
        return window.Dispatcher.Invoke(
            () =>
            {
                ...
                {
                    // 通过反射或公开属性获取 WebView
                    var webViewField = window.GetType().GetField(
                        "WebView", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
    ...
    private async Task<string?> ExecuteScriptAsync(string script)
    {
        ...
        try
        {
            return await window.Dispatcher
                .InvokeAsync(async () =>
                             {
